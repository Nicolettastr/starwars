...
import '../../styles/singleStylePlanets.css'
        ...
        <>
            <div className="container single_view">
                <div className="container d-flex justify-content-center">
                    <div className="card mb-3 rounded-0 single_planetsColor" style={{ maxWidth: "740px" }}>
                        <div className="row g-0 ">
                            <div className="col-md-12 figureContainer">
                                <figure className="imgContainer">
                                    <img src={`https://starwars-visualguide.com/assets/img/planets/${props.theid.theid}.jpg`} alt="Imagen no encontrada" />
                                </figure>
                            </div>
